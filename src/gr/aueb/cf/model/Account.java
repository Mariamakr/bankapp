...
public class Account extends IdentifiableEntity {
     ...
     * @param amount
     * @param ssn
     * @throws InsufficientBalanceExceptions
     * @throws SsnNotValidException
     * @throws NegativeAmountException
     */
    public void withdraw(double amount, String ssn)
        throws InsufficientBalanceExceptions, SsnNotValidException, NegativeAmountException {
      try{
          if (amount < 0) throw new NegativeAmountException(amount);
          if (amount > balance) throw new InsufficientBalanceExceptions(getBalance(), amount);
          if(!isSsnValid(ssn)) throw new SsnNotValidException(ssn);

          balance -= amount;

      }catch (InsufficientBalanceExceptions | SsnNotValidException | NegativeAmountException e) {
